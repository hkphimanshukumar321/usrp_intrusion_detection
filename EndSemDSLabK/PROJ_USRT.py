...
class PROJ_USRT(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PROJ_USRT")
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(8, [32])
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(16, [64])
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-20), 20, 0)
        self.blocks_peak_detector_xb_0 = blocks.peak_detector_fb(10, 20, 10, 0.001)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_char*1)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'K.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.audio_sink_0 = audio.sink(samp_rate, '', True)
        self.analog_sig_source_x_2 = analog.sig_source_b(samp_rate, analog.GR_COS_WAVE, 1000, 100, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 100, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_agc_xx_0 = analog.agc_cc((1e-4), 1.0, 10, 65536)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.digital_constellation_modulator_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self.blocks_threshold_ff_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_0, 0))
...
def main(top_block_cls=PROJ_USRT, options=None):
